/* Day 13 - SAS function showcase against sashelp.cars */
/* Character, numeric, date, and automatic-variable functions in one DATA step. */
...
proc print data=all_functions(obs=5);
run;
